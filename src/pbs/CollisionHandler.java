...
public abstract class CollisionHandler {
	...
	public CollisionHandler(BodyLayer<Entity> layer1, BodyLayer<Entity> layer2) {
		left = layer1;
		right = layer2;
	}

	private Rectangle2D getBoundingBoxForBody(Entity body) {
		return new Rectangle2D.Double(body.getPosition().getX(), body
				.getPosition().getY(), body.getWidth() - 1,
				body.getHeight() - 1);
	}
