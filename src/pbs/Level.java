...
public class Level {
	...
	public static enum Layer {
		BACKGROUND, STATIC, FX, ENEMY, HOSTILE, FRIENDLY, PLAYER, FOREGROUND
	}
	...
	public void setupCollisionHandlers() {
		 ...
		 * getLayer(Layer.PLAYER)){ public void collide(Entity body1, Entity
		 * body2){ //this is where you define behavior for a collision //body1
		 * is from static layer //body2 is from player layer } });
		 */
